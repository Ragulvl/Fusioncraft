        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-3 gap-8 mt-16 animate-slide-in-up">
            <div className="text-center">
              <div className="font-orbitron text-2xl md:text-3xl font-bold text-gradient-primary">{companyData.stats.projects}+</div>
              <div className="text-sm text-muted-foreground">Projects Delivered</div>
            </div>
            <div className="text-center">
              <div className="font-orbitron text-2xl md:text-3xl font-bold text-gradient-primary">{companyData.stats.clients}+</div>
              <div className="text-sm text-muted-foreground">Happy Clients</div>
            </div>
            <div className="text-center">
              <div className="font-orbitron text-2xl md:text-3xl font-bold text-gradient-primary">{companyData.stats.experience}+</div>
